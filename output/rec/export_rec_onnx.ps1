...
$ConfigPath = Join-Path $ProjectDir "configs\rec\PP-OCRv4_mobile_rec_finetune.yml"
$BestModelPrefix = Join-Path $RecOutputDir "best_accuracy"
$InferenceDir = Join-Path $RecOutputDir "inference_legacy"
$OnnxDir = Join-Path $RecOutputDir "onnx"
$OnnxPath = Join-Path $OnnxDir "ch_PP-OCRv4_rec_infer.onnx"

Write-Host "== PPOCRv4 Rec export to ONNX =="
